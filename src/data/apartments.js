...
export const apartments = [
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    rooms: 0, area: 28, floor: 5, ceilingHeight: 2.7,
    description: 'Компактная студия с рациональной планировкой. Французский балкон добавляет света и воздуха.',
  ...
  },
  {
    ...
    rooms: 0, area: 31, floor: 3, ceilingHeight: 2.7,
    description: 'Просторная студия с удобной планировкой и большими окнами.',
  ...
  },
  {
    ...
    rooms: 0, area: 34, floor: 8, ceilingHeight: 2.8,
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    rooms: 1, area: 42, floor: 7, ceilingHeight: 2.7,
    description: 'Уютная однокомнатная квартира с удобной планировкой. Большие окна обеспечивают хорошую инсоляцию.',
  ...
  },
  {
    ...
    rooms: 1, area: 38, floor: 4, ceilingHeight: 2.7,
    description: 'Компактная однокомнатная квартира с продуманным зонированием.',
  ...
  },
  {
    ...
    rooms: 1, area: 45, floor: 11, ceilingHeight: 2.7,
    description: 'Добавь описание после осмотра планировки.',
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    rooms: 2, area: 67, floor: 12, ceilingHeight: 2.7,
    description: 'Просторная двухкомнатная квартира с изолированными комнатами.',
  ...
  },
  {
    ...
    rooms: 2, area: 72, floor: 6, ceilingHeight: 2.7,
    description: 'Добавь описание после осмотра планировки.',
    features: ['Просторная планировка'],
    ...photos('apt-2room-2'),
  ...
  },
  {
    ...
    rooms: 2, area: 78, floor: 9, ceilingHeight: 2.8,
    description: 'Добавь описание после осмотра планировки.',
    features: ['Просторная планировка'],
    ...photos('apt-2room-3'),
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    rooms: 3, area: 76, floor: 9, ceilingHeight: 2.8,
    description: 'Просторная трёхкомнатная квартира с двумя изолированными спальнями, кухней-гостиной и отдельной гостиной.',
  ...
  },
  {
    ...
    rooms: 3, area: 106, floor: 6, ceilingHeight: 2.8,
    description: 'Просторная трёхкомнатная квартира 106 м² с открытой кухней-гостиной, двумя изолированными спальнями.',
  ...
  },
  {
    ...
    rooms: 3, area: 95, floor: 14, ceilingHeight: 2.8,
    description: 'Добавь описание после осмотра планировки.',
    features: ['Просторная планировка'],
    ...photos('apt-3room-3'),
  ...
  // ══════════════════════════════════════════════════════════════
  // ПОЛЬЗОВАТЕЛЬСКАЯ ПЛАНИРОВКА
  // ══════════════════════════════════════════════════════════════
  {
    id: 'custom',
    title: 'Своя планировка', subtitle: '',
    rooms: null, area: 0, floor: null, ceilingHeight: 2.7,
    description: 'Пользовательская планировка, загруженная в формате GLB.',
    features: [],
    plan: null, preview: null, firstperson: null,
    modelPath: null, // будет подставлен Object URL из памяти браузера
    rooms_data: null, defaultFurniture: [],
  },
]